...
allids <- read.table("~/Documents/GitHub/esade_fake_news/1_Climate_Change/youtube_recommendation_scrapper/data/csv/climate_20200501_unique_ids.csv", header=TRUE)
...
URL_key='AIzaSyAn8lYgin9KQIOuJYQsxJhELOuXq2w2-9E'
...
write.csv(alldata, "~/Documents/GitHub/esade_fake_news/1_Climate_Change/youtube_api_request_info/data/contentDetails_climate_v1.csv")
...
#write to csv in case something goes wrong.
write.csv(alldata, "~/Documents/GitHub/esade_fake_news/1_Climate_Change/youtube_api_request_info/data/snippet_climate_v1.csv")
...
#write to csv in case something goes wrong.
write.csv(alldata, "~/Documents/GitHub/esade_fake_news/1_Climate_Change/youtube_api_request_info/data/statistics_climate_v1.csv")
...
write.csv(unique_category, "~/Documents/GitHub/esade_fake_news/1_Climate_Change/youtube_api_request_info/data/climate_category_list.csv")
alldata6 = data.frame()
...
write.csv(alldata7, "~/Documents/GitHub/esade_fake_news/1_Climate_Change/youtube_api_request_info/data/climate_v1.csv")
